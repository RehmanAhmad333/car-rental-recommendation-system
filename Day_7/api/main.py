...
def get_recommendation(
    category: str = Query(
                           ..., 
                          description="The category of the car (e.g., SUV, sedan, etc.)"
                          ), 
    max_price: float = Query(
                            ..., 
                            description="The maximum price per day for the car rental."
                            ), 
    top_car: int = Query(
                        5, 
                        description="The number of top recommended cars to return."
                        )
):
    try:
